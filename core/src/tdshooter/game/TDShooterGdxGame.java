...
public class TDShooterGdxGame extends Game {
	...
	public void create() {
        ...
        assets.load("Menu/pelitila-equipmentjuttu_gun.png", Texture.class);
        assets.load("Menu/pelitila-equipmentjuttu_nuke.png", Texture.class);
		...
		assets.load("Sounds/menublip.wav", Sound.class);
		assets.load("Sounds/menublip2.wav", Sound.class);
		assets.load("Sounds/menublip3.wav", Sound.class);
		assets.load("Sounds/hydraulics.wav", Sound.class);
